      ...
      <div className="p-4 w-full sm:1/2 md:1/3 lg:1/4">
        ...
        >
          ...
          <div
            ...
            group-hover:bg-opacity-50 transition-opacity duration-300 flex
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              <Link
                ...
                className="bg-red-600 hover:bg-red-700
                     text-white px-4 py-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              >
                {" "}
                View 
              </Link>
